    ...
    computed: {
      ...
      leftContent() {
        ...
        return {
          ...
          6: `${this.data.realname || this.data.createUserEmail} 拒绝您的`,
      ...
      rightContent() {
        return {
          ...
          1: `${this.isTimeIterationTask ? '迭代分配给您，请及时查看' : '任务分配给您，请及时查看'}`,
          2: `${this.isTimeIterationTask ? '迭代，请及时查看' : '任务，请及时查看'}`,
          3: `${this.isTimeIterationTask ? '迭代标记结束' : '任务标记结束'}`,
          4: '日志，请及时查看',
          5: '发送给您，请及时查看',
          6: '，请及时处理',
          7: '，请及时查看',
